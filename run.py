...
def train(args, train_dataset, model, tokenizer):
    ...
    for _ in train_iterator:
        ...
        for step, batch in enumerate(epoch_iterator):
            ...
            if args.use_context_keyword:
                inputs["keyword_type_ids"] = batch[8]
            else:
                inputs["keyword_type_ids"] = batch[9]
...
def evaluate(args, model, tokenizer, prefix=""):
    ...
    for batch in tqdm(eval_dataloader, desc="Evaluating"):
        ...
        with torch.no_grad():
            ...
            if args.use_context_keyword:
                inputs["keyword_type_ids"] = batch[6]
            else:
                inputs["keyword_type_ids"] = batch[7]
...
def load_and_cache_examples(args, tokenizer, evaluate=False, output_examples=False):
    ...
    if os.path.exists(cached_features_file) and not args.overwrite_cache:
        ...
        features, dataset = lic2020_convert_examples_to_features(
            ...
            use_context_keyword = args.use_context_keyword,
        )
...
def main():
    ...
    parser.add_argument(
        "--use_context_keyword",
        action="store_true",
        help="Use the keyword flag in both context and query or only in query",
    )
    ...
    #config.use_absolute_position = args.use_absolute_position
    #if args.use_absolute_position:
